...
void setup() {
  ...
  //Serial.println( myIMU.setIncrement() ); // returns a 1  //GOOD
  Serial.println( myIMU.begin()); // returns a 1 
  
  //Serial.println(myIMU.beginCore() );

  // IF YOU DO NOT INITIALIZE THE SETTINGS, THEN IT WONT WORK
